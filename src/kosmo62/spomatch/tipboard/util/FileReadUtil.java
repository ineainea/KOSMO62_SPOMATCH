package kosmo62.spomatch.tipboard.util;
...
public class FileReadUtil {
	...
	public static void readFile(HttpServletRequest request
		...
		String stb_file = (String)request.getAttribute("stb_file");
		String path = (String)request.getAttribute("path");
		
		logger.info("smb_file : " + stb_file + ", path >>> : " + path);
		
		String realFilePath = path  + "/" + stb_file;
		...
		response.setHeader("Content-Disposition","attachment; filename=" + stb_file + ";");
