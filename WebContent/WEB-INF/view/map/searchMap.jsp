...
<div id="mapwrap">
	...
	<div class="wrap_search">
		<select id="searchFilter" name="searchFilter" class="btn1">
		...
		<input type="button" onclick="dbData2()" id="search_btn" name="search_btn" class="btn1" value="검색">
	</div>
		...
		var infowindow = new kakao.maps.InfoWindow(
				{
					content : ajaxData2.name
							+ "<br>"
							+ ajaxData2.hp
							+ '<div style="padding:10px;"><a href="https://map.kakao.com/link/map/Hello World!" style="color:blue" target="_blank">지도보기</a> <a href="https://map.kakao.com/link/to/Hello World!,33.450701,126.570667" style="color:blue" target="_blank">길찾기</a></div>',
